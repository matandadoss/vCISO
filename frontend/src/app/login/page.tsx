...
export default function LoginPage() {
  const { user, signInWithGoogle, signInWithMicrosoft, signInWithEmail, signUpWithEmail, resetPassword, loading, isMock } = useAuth();
  ...
  return (
    <div className="min-h-screen w-full bg-muted/20 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full sm:max-w-md relative z-10">
        ...
        <div className="bg-card w-full py-10 px-6 sm:px-10 border border-border rounded-xl shadow-2xl backdrop-blur-sm">
             ...
             <div className="flex flex-col gap-3">
               ...
               >
                   {isConfigured ? (
                    ...
                    <>
                      <LogIn className="w-5 h-5" />
                      {process.env.NODE_ENV !== "production" ? "Bypass With Google Login" : "Demo Google Login"}
                    </>
                  )}
               </button>
               ...
               >
                   {isConfigured ? (
                    ...
                    <>
                      <LogIn className="w-5 h-5" />
                      {process.env.NODE_ENV !== "production" ? "Bypass With Microsoft Login" : "Demo Microsoft Login"}
                    </>
                  )}
               </button>
             </div>
