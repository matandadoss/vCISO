...
export default function IntegrationsPage() {
  ...
  const handleMagicConnect = async () => {
    ...
    setMagicResult(null);
    try {
      const res = await fetchWithAuth("http://localhost:8000/api/v1/integrations/magic-connect", {
        method: "POST",
  ...
  useEffect(() => {
    async function fetchIntegrations() {
      try {
        const res = await fetchWithAuth("http://localhost:8000/api/v1/integrations");
        const data = await res.json();
  ...
  const handleToggle = async (id: string, currentStatus: string) => {
    ...
    try {
      const res = await fetchWithAuth("http://localhost:8000/api/v1/integrations/toggle", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
           ...
           <div className="relative z-10 max-w-3xl">
              ...
              <div className="flex items-center justify-between mt-4">
                 ...
                 <button 
                   ...
                   className="px-6 py-2 bg-primary text-primary-foreground font-medium text-sm rounded-md shadow-sm hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                 >
